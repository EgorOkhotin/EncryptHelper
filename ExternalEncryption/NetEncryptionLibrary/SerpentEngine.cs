...
namespace ExternalEncryption.NetEncryptionLibrary
{
    ...
    : SerpentEngineBase, ICryptoTransform, IDisposable
    {
        ...
        public const int BLOCK_BIT_SIZE = 128;

        public SerpentEngine(byte[] key, bool encrypting)
        {
...
*/
        ...
        */
        ...
        {
            var result =  ProcessBlock(inputBuffer, inputOffset, outputBuffer, outputOffset);
            return result;
        }
        ...
        public byte[] TransformFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
        {
            ...
            return inputBuffer;
            //int outputOffset = 0;
            //ProcessBlock(inputBuffer, inputOffset, outputBuffer, outputOffset);
            //return outputBuffer;
        }
